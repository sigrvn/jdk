...
private:
  ...
  // The following members are for tracking non-GC safepoint times.
  ...
  jlong _yield_duration_in_refinement_epoch;       // Time spent in safepoint since beginning of last refinement epoch.
