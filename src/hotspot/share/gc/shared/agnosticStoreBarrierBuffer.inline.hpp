...
#ifndef SHARE_GC_SHARED_AGNOSTICSTOREBARRIERBUFFER_INLINE_HPP
#define SHARE_GC_SHARED_AGNOSTICSTOREBARRIERBUFFER_INLINE_HPP
...
inline size_t AgnosticStoreBarrierBuffer::current() const {
